...
#### Home
![Tipografia](../assets/guia-de-estilos/Captura_home.png)
<center>Figura 1: Home<br>[Link para a imagem expandida](../assets/guia-de-estilos/Captura_home.png)</center>

#### Balcão Virtual
![Tipografia](../assets/guia-de-estilos/Captura_balcao_virtual.png)
<center>Figura 2: Balcão Virtual<br>[Link para a imagem expandida](../assets/guia-de-estilos/Captura_balcao_virtual.png)</center>

#### Calendário
![Tipografia](../assets/guia-de-estilos/Captura_calendario.png)
<center>Figura 3: Calendário<br>[Link para a imagem expandida](../assets/guia-de-estilos/Captura_calendario.png)</center>

#### Concursos
![Tipografia](../assets/guia-de-estilos/Captura_concursos.png)
<center>Figura 4: Concursos<br>[Link para a imagem expandida](../assets/guia-de-estilos/Captura_concursos.png)</center>

#### Consultar Processos
![Tipografia](../assets/guia-de-estilos/Captura_consultar_processo.png)
<center>Figura 5: Consultar Processos<br>[Link para a imagem expandida](../assets/guia-de-estilos/Captura_consultar_processo.png)</center>
...
<center>Figura 7: Ouvidoria<br>[Link para a imagem expandida](../assets/guia-de-estilos/Captura_ouvidoria.png)</center>

#### Solicitar Atendimento
![Tipografia](../assets/guia-de-estilos/Captura_solicitar_atendimento.png)
<center>Figura 8: Solicitar Atendimento<br>[Link para a imagem expandida](../assets/guia-de-estilos/Captura_solicitar_atendimento.png)</center>



### Tipografia
![Tipografia](../assets/guia-de-estilos/tipografia.png)
<center>Figura 9: Tipografia<br>[Link para a imagem expandida](../assets/guia-de-estilos/tipografia.png)</center>
...
<center>Figura 10: Paleta de cores da logo<br>[Link para a imagem expandida](../assets/guia-de-estilos/paleta-de-cores-logo.png)</center>

Paleta de cores predominantes no site:

![Paleta Site](../assets/guia-de-estilos/paleta-de-cores-site.png)
<center>Figura 11: Paleta de cores do site<br>[Link para a imagem expandida](../assets/guia-de-estilos/paleta-de-cores-site.png)</center>
...
<center>Figura 12: Menu do usuário<br>[Link para a imagem expandida](../assets/guia-de-estilos/menu.gif)</center>

#### Notícias
![Animação 2](../assets/guia-de-estilos/menu2.gif)
<center>Figura 13: Notícias<br>[Link para a imagem expandida](../assets/guia-de-estilos/menu2.gif)</center>

#### Páginas do Portal
![Animação 3](../assets/guia-de-estilos/menu3.gif)
<center>Figura 14: Páginas do portal<br>[Link para a imagem expandida](../assets/guia-de-estilos/menu3.gif)</center>
...
&emsp;&emsp;Todos os campos de preenchimento devem ser preenchidos manualmente pelo usuário segundo as suas necessidades.<br>Exemplo:

![Preenchimento de campo](../assets/guia-de-estilos/preenchimento-de-campo.png)
<center>Figura 15: Preenchimento de campos<br>[Link para a imagem expandida](../assets/guia-de-estilos/preenchimento-de-campo.png)</center>
